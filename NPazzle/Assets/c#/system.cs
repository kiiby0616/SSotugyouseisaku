...
public class system : MonoBehaviour {
    ...
    public GameObject kasol;
    private GameObject _kasol;
    void instanceDis(Vector3 pos)
    {
        _kasol = Instantiate(kasol) as GameObject;
        _kasol.transform.position = pos;
    }
        ...
        if(holdObj == null)
        {
            ...
            if (set.Length == 1)
            {
                ...
                if (col != null)
                {
                    ...
                    instanceDis(holdObj.transform.position);
                }
                if (colU != null)
                {
   ...
   private void kaunto()
    ...
    private void kaunsyuti(int objN)
    {
        if(objN >= 0 && objN <= 3)
        {
            kaunto score = this.score.GetComponent<kaunto>();
